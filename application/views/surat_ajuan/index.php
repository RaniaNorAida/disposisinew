<main>
    <div class="container-fluid">
        ...
        <div class="card mb-4">
            <div class="card-header"> <a href="<?php echo site_url('surat_ajuan/add') ?>"><i cl ass="fas fa-plus"></i> Add New</a>
            </div>
                    ...
                    <table class="table table-striped table-bordered table-hover" id="tabelsurat" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            foreach ($surat as $suratdata) {
                                ...
                                <td><img src=" . base_url('assets/photo/surat_masuk/' . $suratdata->image) . " width ='100'/></td>
                                <td>
                                <div><a href=" . base_url('surat_ajuan/getedit/' . $suratdata->id) . " class='btn btn-sm btn-info'><i class='fas fa-edit'></i> Edit</a>
